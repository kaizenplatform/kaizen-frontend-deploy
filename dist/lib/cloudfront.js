...
module.exports = {
  invalidate: (() => {
    var _ref = _asyncToGenerator(function* (localDir, awsAccessKeyId, awsSecretAccessKey, distributionId, s3Prefix = '') {
      return new Promise(function (resolve, reject) {
        ...
        recursive(localDir, function (err, files) {
          if (err) {
    ...
    function invalidate(_x, _x2, _x3, _x4) {
